...
import com.example.extraplanet.ReplacerActivity;
import com.example.extraplanet.MainActivity;
        ...
        signUpBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.isEmpty() || name.equals(" ")) {
                    nameEt.setError("사용가능한 이름을 입력해 주세요");
                    return;
                }

                if (email.isEmpty() || !email.matches(EMAIL_REGEX)) {
                    emailEt.setError("사용가능한 이메일을 입력해 주세요");
                    return;
                }

                if (password.isEmpty() || password.length() < 6) {
                    passwordEt.setError("6자리 이상의 사용가능한 비밀번호를 입력해 주세요");
                    return;
                }

                if (!password.equals(confirmPassword)) {
                    confirmPasswordEt.setError("비밀번호가 일치하지 않습니다");
                    return;
                }
